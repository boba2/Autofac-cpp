...
namespace DI
{
	...
	template<class T>
	template<class U>
	auto ServiceRegisterer<T>::registerFactory(U factory) -> ServiceFactoryRegisterer<typename Details::UnderlyingType<typename Details::FunctionResultType<U>::Type>::Type>
	{
